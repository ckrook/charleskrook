...
const SelectedWorkSection = ({ selectedWork }: SelectedWorkSectionProps) => {
  return (
    <div className="my-16 col-span-4 sm:col-start-1 sm:col-end-9">
      <h2 className="px-0 md:px-4 col-span-4 sm:col-start-1 sm:col-end-9 ">
        Selected Work
      </h2>
      <p className="px-0 md:px-4 col-span-4 sm:col-start-1 sm:col-end-5 mb-8 w-full md:w-1/2">
        <span className="text-black dark:text-white">
          A selection of my work over the years that I&apos;m extra proud of.{" "}
        </span>
        <span className="text-stone-300 dark:text-grey-800">
